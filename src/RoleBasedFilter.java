...
public class RoleBasedFilter {
	...
	public static void main(String[] args) {
        ...
        streamFilter(getUserMap(), role).forEach(System.out::println);
		}
       ...
       private static Map<Integer, Customer> getUserMap() {
        ...
        private static List<Customer> streamFilter(Map<Integer, Customer> userMap, String role) {
		List<Customer> userList = userMap.values().stream().filter(u -> u.getRole().equalsIgnoreCase(role))
